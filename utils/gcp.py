...
def bigquery_etl_query(
    ...
    **kwargs,
    ...
    args = [BQETL_SCRIPT, "query", "run-multipart"] if multipart else ["query"]
    return GKEPodOperator(
...
def bigquery_etl_copy_deduplicate(
    ...
    **kwargs,
    ...
    return GKEPodOperator(
        ...
        namespace=gke_namespace,
        image=docker_image,
        arguments=[BQETL_SCRIPT, "copy_deduplicate"]
...
def bigquery_dq_check(
    ...
    **kwargs,
    ...
    args = [BQETL_SCRIPT, "check", "run", *marker, sql_file_path]
    return GKEPodOperator(
        gcp_conn_id=gcp_conn_id,
        project_id=gke_project_id,
        location=gke_location,
