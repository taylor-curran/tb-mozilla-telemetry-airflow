...
@dataclass
class GkeConfig:
    """Configuration for GKE Pod Operator infrastructure settings."""
...
def bigquery_etl_copy_deduplicate(
    ...
    **kwargs,
    ...
    :param GkeConfig gke_config:     GKE infrastructure configuration (connection, cluster,
                                     namespace, and docker image settings)
    :param Dict[str, Any] kwargs:    Additional keyword arguments for
                                     GKEPodOperator
    ...
    return GKEPodOperator(
        ...
        project_id=gke_config.gke_project_id,
        location=gke_config.gke_location,
        cluster_name=gke_config.gke_cluster_name,
        namespace=gke_config.gke_namespace,
