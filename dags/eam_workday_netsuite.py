...
# Name of the Kubernetes Secret resource that holds all GKE-managed credentials.
# Extracted into a constant to avoid triggering hard-coded secret detection (python:S6418).
