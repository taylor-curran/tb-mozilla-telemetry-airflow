...
_BILLING_PROJECT_BATCH_PROD = "--billing-project=moz-fx-data-bq-batch-prod"
_FIREFOX_DESKTOP_STABLE_METRICS_V1 = "firefox_desktop_stable.metrics_v1"
base_command = [
...
flat_rate = GKEPodOperator(
    ...
    arguments=[
        *base_command,
        ...
        _FIREFOX_DESKTOP_STABLE_METRICS_V1,
        # force no dml
