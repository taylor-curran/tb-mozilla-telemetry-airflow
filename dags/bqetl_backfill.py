...
def _append_optional_params(cmd, params):
    """Append optional parameters to the backfill command."""
...
def _append_flag_params(cmd, params):
    """Append boolean flag parameters to the backfill command."""
    if params["dry_run"]:
        cmd.append("--dry_run")
...
def bqetl_backfill_dag():
    ...
    def generate_backfill_command(**context):
        ...
        _append_optional_params(cmd, params)
        _append_flag_params(cmd, params)
