...
def _get_spark_type(prop, meta):
    """Return the appropriate StructField for a single JSON schema property."""
    meta_type = meta["type"]
    nullable = "null" in meta_type
...
def get_rows(schema):
    ...
    for prop in sorted(schema["properties"]):
        ...
        yield _get_spark_type(prop, meta)
