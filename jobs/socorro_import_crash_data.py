...
def _parse_field(prop, meta):
    """Parse a single JSON schema field into a pyspark StructField."""
...
def backfill(
    ...
    -------
        backfill(
            "20160902",
            "gs://moz-fx-data-prod-socorro/v1/crash_report",
            "gs://moz-fx-data-prod-socorro/socorro_crash_parquet",
            crash_schema,
            version,
        )
